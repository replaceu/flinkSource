...
public class CliFrontend {
	...
	/**
	 * Submits the job based on the arguments根据参数提交作业
	 */
	public static void main(final String[] args) {
		...
		//todo:选择创建哪种类型的客户端，这里依次添加了Generic，Yarn，Default三种命令行客户端
	...
	public CustomCommandLine validateAndGetActiveCommandLine(CommandLine commandLine) {
		...
		for (CustomCommandLine cli : customCommandLines) {
			...
			//todo：在FlinkYarnSessionCli为active时优先返回FlinkYarnSessionCli
			//todo：对于DefaultCli，它的isActive方法总是返回true
